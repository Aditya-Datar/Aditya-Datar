<!-- HEADER WAVE BANNER -->
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:0a0a0f,30:0d1b2a,70:1a2744,100:0d2137&height=220&section=header&text=Aditya%20Datar&fontSize=62&fontColor=38BDF8&fontAlignY=38&desc=Software%20Engineer%20%C2%B7%20USC%20Viterbi%20M.S.%20CS%20%C2%B7%20Builder%20of%20Things%20That%20Work&descAlignY=60&descSize=15&descColor=94a3b8&animation=fadeIn"/>
...
![Ollama](https://img.shields.io/badge/Ollama_DeepSeek-1C1C1C?style=flat-square&logo=llvm&logoColor=white)
![RAG](https://img.shields.io/badge/RAG_Pipelines-FF6B35?style=flat-square&logoColor=white)
![Vector](https://img.shields.io/badge/Vector_Search-8A2BE2?style=flat-square&logoColor=white)
...
![NeonDB](https://img.shields.io/badge/NeonDB-00E699?style=flat-square&logoColor=black)
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>
        ...
        <img src="https://img.shields.io/badge/DeepSeek_Ollama-1C1C1C?style=flat-square&logoColor=white"/>
        <img src="https://img.shields.io/badge/NeonDB-00E699?style=flat-square&logoColor=black"/>
      </p>
    </td>
    <td width="50%" valign="top">
      <h3>⚡ SupportSync &nbsp;·&nbsp; Slack Intelligence</h3>
      <p><sub>USC · Nov 2025</sub></p>
      <p>Ingests Slack chaos in <strong>&lt;500ms</strong>, clusters issues via vector embeddings + LLM intent detection, surfaces them on a live WebSocket dashboard. <strong>65% fewer duplicate tickets.</strong></p>
      <p>
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <p>Secure CBDC distribution with biometric auth + QR flows, deployed edge-side on a <strong>Raspberry Pi</strong>. Patent filed across two continents.</p>
      <p>
        <img src="https://img.shields.io/badge/Python-3776AB?style=flat-square&logo=python&logoColor=white"/>
...
[![LinkedIn](https://img.shields.io/badge/-Connect_on_LinkedIn-0d2137?style=for-the-badge&logo=linkedin&logoColor=38BDF8)](https://www.linkedin.com/in/aditya-datar-5b6675204)
&nbsp;
...
{
  "name": "Aditya Datar",
  "roles": ["full stack engineer", "backend engineer", "AI engineer", "software engineer"],
  "keywords": ["Java","Spring Boot","Microservices","React","Python","FastAPI","Django","AWS","RAG","LLM","Vector Search","WebSockets","LoRa","IoT","OCR","NLP","Gemini","OpenAI","DeepSeek","Ollama","Docker","Kubernetes","Embedded C","Arduino","Raspberry Pi"],
  "highlights": {
    "api_users": 1500,
    "automation_savings_usd_per_resource": 2200,
    "automation_hours_saved_per_cycle": 8,
    "duplicate_ticket_reduction_percent": 65,
    "ocr_accuracy_improvement_percent": 80,
    "deployment_time_reduction_percent": 35,
    "patents": "4+",
